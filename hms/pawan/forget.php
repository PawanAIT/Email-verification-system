...
if($_POST['register'])
{
    ...
    else
    {
		...
		$body.="Your e-mail address for logging in is $email. <br><br> <button style='background-color: #4CAF50;font-size: 16px;border-radius: 8px;padding: 10px 20px;'><a style='text-decoration: none; color:#fff' href='https://bitcoinindia.in/pawan/reset.php?token=$encrypt';>Activate</a></button>";
		$body.="<br><br>";
		...
		$body.="</div>";
           ...
           /* 
            ...
            $body='Hi, <br/> <br/> <br><br>Click here to reset your password https://bitcoinindia/pawan/reset.php?encrypt='.$encrypt.';;
